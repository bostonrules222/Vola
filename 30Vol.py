...
stock_iv30 = quandl.get(stock.upper(), column_index='27')
stock_hv30 = quandl.get(stock.upper(), column_index='3')
hv30 = stock_hv30[['Hv30']].to_numpy()
iv30 = stock_iv30[['IvMean30']].to_numpy()
